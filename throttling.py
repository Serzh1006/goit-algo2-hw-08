...
class ThrottlingRateLimiter:
    ...
    def record_message(self, user_id: str) -> bool:
        """Записує час останнього повідомлення, якщо воно дозволене"""
    ...
    def time_until_next_allowed(self, user_id: str) -> float:
        """Повертає час у секундах, коли користувач зможе відправити наступне повідомлення"""
        last_time = self.last_message_time.get(user_id)
        if last_time is None:
            return 0.0
        remaining = self.min_interval - (time.time() - last_time)
